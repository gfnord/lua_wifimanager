print("Lua WIFI Manager ")
print("https://github.com/gfnord/lua_wifimanager")
...
function receiver(sck, data)
  ...
  local title = "AQS Sensor"
  local subtitle = "Configure AQS Sensor Wifi</h2><p>Use the following form to connect this AQS Sensor on your Wifi network"
  ...
  response[#response + 1] = "<div>Powered by <a href=\"https://www.levare.io\">Levare Research Inc @ 2018</a></div></div></body></html>"
